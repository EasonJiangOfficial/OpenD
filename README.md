...
```
dfx canister call opend_backend listItem '(principal "htxyu-tmaaa-aaaaa-qaauq-cai", 2)'
```
...
```
dfx canister call htxyu-tmaaa-aaaaa-qaauq-cai transferOwnership '(principal "be2us-64aaa-aaaaa-qaabq-cai", true)'
```
